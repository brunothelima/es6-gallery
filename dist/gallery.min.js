...
eval("exports = module.exports = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\")(true);\n// Module\nexports.push([module.i, \".gallery{--width: 600px;--height: 300px;--gutter: 8px;--speed: 150ms;overflow:hidden;width:var(--width);margin:auto}.gallery:not(.gallery--active)>*{display:none}.gallery__lens{display:flex;align-items:center;justify-content:center;height:var(--height)}.gallery__item{overflow:hidden;display:none;align-items:center;justify-content:center;height:var(--height)}.gallery__item--active{display:flex;width:100%;opacity:0;animation:item var(--speed) ease-out forwards}.gallery__controlls{box-sizing:border-box;padding:calc(var(--gutter) * 2);text-align:center}.gallery__index--active{background:salmon}@keyframes item{from{opacity:0}to{opacity:1}}\\n\", \"\",{\"version\":3,\"sources\":[\"/usr/local/var/www/exp/src/src/style.scss\"],\"names\":[],\"mappings\":\"AAAA,SACC,cAAQ,CACR,eAAS,CACT,aAAS,CACT,cAAQ,CACR,eAAgB,CAChB,kBAAmB,CACnB,WAAY,CAPb,iCASE,YAAa,CACb,eAEA,YAAa,CACb,kBAAmB,CACnB,sBAAuB,CACvB,oBAAqB,CACrB,eAEA,eAAgB,CAChB,YAAa,CACb,kBAAmB,CACnB,sBAAuB,CACvB,oBAAqB,CACrB,uBACC,YAAa,CACb,UAAW,CACX,SAAU,CACV,6CAA8C,CAC9C,oBAGD,qBAAsB,CACtB,+BAAgC,CAChC,iBAAkB,CAClB,wBAGC,iBAAkB,CAClB,gBAIF,KACC,SAAU,CACT,GACD,SAAU,CAAA\",\"file\":\"style.scss\",\"sourcesContent\":[\".gallery {\\n\\t--width: 600px;\\n\\t--height: 300px;\\n\\t--gutter: 8px;\\n\\t--speed: 150ms;\\n\\toverflow: hidden;\\n\\twidth: var(--width);\\n\\tmargin: auto;\\n\\t&:not(.gallery--active) > * {\\n\\t\\tdisplay: none;\\n\\t}\\n\\t&__lens {\\n\\t\\tdisplay: flex;\\t\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\theight: var(--height);\\n\\t}\\n\\t&__item {\\n\\t\\toverflow: hidden;\\n\\t\\tdisplay: none;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\theight: var(--height);\\n\\t\\t&--active {\\n\\t\\t\\tdisplay: flex;\\t\\n\\t\\t\\twidth: 100%;\\n\\t\\t\\topacity: 0;\\n\\t\\t\\tanimation: item var(--speed) ease-out forwards;\\n\\t\\t}\\n\\t}\\n\\t&__controlls {\\n\\t\\tbox-sizing: border-box;\\n\\t\\tpadding: calc(var(--gutter) * 2);\\n\\t\\ttext-align: center;\\n\\t}\\n\\t&__index {\\n\\t\\t&--active {\\n\\t\\t\\tbackground: salmon;\\n\\t\\t}\\n\\t}\\n}\\n@keyframes item {\\n\\tfrom {\\n\\t\\topacity: 0;\\n\\t} to {\\n\\t\\topacity: 1;\\n\\t}\\n}\"],\"sourceRoot\":\"\"}]);\n\n\n\n//# sourceURL=webpack://Gallery/./src/style.scss?./node_modules/css-loader/dist/cjs.js??ref--4-1!./node_modules/sass-loader/lib/loader.js??ref--4-2");
